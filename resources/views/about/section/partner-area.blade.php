<section class="partners-area pt-125 pb-130">
		<div class="container">
			...
			<div class="partners-wrapper wow fadeInUp">
				...
				<div class="partner-item">
					<div class="img-holder">
						<img src="{{ asset('images/partners/img-5.png')}} " alt="">
					</div>
				</div>
				<div class="partner-item">
					<div class="img-holder">
						<img src="{{ asset('images/partners/img-6.png')}} " alt="">
					</div>
				</div>
				<div class="partner-item">
					<div class="img-holder">
						<img src="{{ asset('images/partners/img-7.png')}} " alt="">
					</div>
				</div>
				<div class="partner-item">
					<div class="img-holder">
						<img src="{{ asset('images/partners/img-8.png')}} " alt="">
					</div>
				</div>
				<div class="partner-item">
					<div class="img-holder">
						<img src="{{ asset('images/partners/img-9.png')}} " alt="">
					</div>
				</div>
				<div class="partner-item">
					<div class="img-holder">
						<img src="{{ asset('images/partners/img-10.png')}} " alt="">
					</div>
				</div>
			</div>
		</div>
