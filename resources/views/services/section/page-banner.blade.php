    <section class="page-banner bg_cover position-relative z-1">
      <div class="shape shape-one scene">
        <span data-depth="1">
          <img src="{{ asset('images/shape/shape-1.png') }}" alt="">
        </span>
      </div>
      <div class="shape shape-two scene">
        <span data-depth="2">
          <img src="{{ asset ('images/shape/shape-2.png') }}" alt="">
        </span>
      </div>
      <div class="shape shape-three scene">
        <span data-depth="3">
          <img src="{{ asset ('images/shape/shape-3.png') }}" alt="">
        </span>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="page-banner-img">
              <img src="{{ asset ('images/breadcrumb/img-2.jpg') }}" alt="">
            </div>
          </div>
        </div>
      </div>
